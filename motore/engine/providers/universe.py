...
def build(cfg: dict, provider, cache: Optional[Cache] = None,
    ...
    # Al bacino serve solo prezzo x volume: la variazione di seduta la si
    # chiedera' dopo, per i 150 che restano, non per tutti e 330.
    quotes = provider.fetch_quotes(pool, log=log, completo=False) \
